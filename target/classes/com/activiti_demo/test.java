...
public class test {
	...
	public void test() {
		...
		processEngine.getRepositoryService().createDeployment().name("MyfirstProcess")
				.addClasspathResource("MyProcess.bmp").addClasspathResource("MyProcess.bpmn").deploy();
	}
	...
	public void test4() {
		ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
		List<Task> tasks = processEngine.getTaskService().createTaskQuery().taskAssignee("鐙勪粊鏉�").list();
